...
const Login = () => {
  ...
  return (
    <div className="container-fluid login-container d-flex align-items-center justify-content-center py-5">

      <div
        className="login-box shadow-lg p-4 rounded bg-white"
      ...
      >
        ...
        <p className="register-text text-center mt-4">
